      ...
      {project.thumbnail && (
        <div className="w-full h-64 md:h-80 overflow-hidden relative">
          <ImageLazy
            ...
            className="w-full h-full rounded-md object-contain transition-transform duration-500 ease-out hover:scale-105 hover:rounded-md hover:transform hover:origin-center"
            alt={project.title}
          />
        </div>
      )}
