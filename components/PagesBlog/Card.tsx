...
const SkeletonCard = ({ featured = false }: { featured?: boolean }) => (
  <div className="rounded-md overflow-hidden dark:bg-gray-900 bg-gray-100">
    <div className={`${featured ? 'w-full h-56 md:h-80' : 'w-full h-48 md:h-56'} dark:bg-gray-800 bg-gray-200`} />
    <div className="p-4">
      ...
      {blogs.length === 0 ? (
        ...
        <>
          <Link href={`/artikel/${blogs[0].slug}`} className="rounded-md w-full block">
            <div className="w-full h-56 md:h-80 relative overflow-hidden rounded-md">
              <ImageLazy
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {blogs.slice(1).map((item) => (
              ...
              >
                <div className="w-full h-48 md:h-56 relative overflow-hidden rounded-md">
                  <ImageLazy
